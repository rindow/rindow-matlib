...
protected:
    virtual void test_matlib_maximum(
        int32_t m,
        int32_t n,
        float *a, int32_t ldA,
    ...
    {
        rindow_matlib_s_maximum(m,n,a,ldA,x,incX);
    }
    virtual void test_matlib_maximum(
        int32_t m,
        int32_t n,
    ...
    {
        rindow_matlib_d_maximum(m,n,a,ldA,x,incX);
    }
};
typedef ::testing::Types<float, double> TestTypes;
TYPED_TEST_SUITE(MaximumTest, TestTypes);

TYPED_TEST(MaximumTest, once) {
    const int32_t M = 1;
    const int32_t N = 6;
    const int32_t ldA = N;
    ...
    this->test_matlib_maximum(M,N,A,ldA,X,incX);
...
TYPED_TEST(MaximumTest, broadcast) {
    const int32_t M = 2;
    const int32_t N = 3;
    const int32_t ldA = N;
    const int32_t incX = 1;
...
TYPED_TEST(MaximumTest, not_a_number_with_num) {
    const int32_t M = 6;
    const int32_t N = 1;
    const int32_t ldA = N;
    const int32_t incX = 1;
    ...
    EXPECT_EQ((TypeParam)1,A[0]);
    EXPECT_EQ((TypeParam)0,A[1]);
    EXPECT_EQ((TypeParam)0,A[2]);
    EXPECT_TRUE(inf==A[3]);
    EXPECT_EQ((TypeParam)0,A[4]);
    EXPECT_TRUE(std::isnan(A[5]));
}
TYPED_TEST(MaximumTest, not_a_number_with_nan) {
    const int32_t M = 6;
    const int32_t N = 1;
    const int32_t ldA = N;
    const int32_t incX = 1;
