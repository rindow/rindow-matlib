...
protected:
    virtual void test_matlib_notequal(
        int32_t n,
        float *x, int32_t incX,
        float *y, int32_t incY)
    {
        rindow_matlib_s_notequal(n,x,incX,y,incY);
    }
    ...
    {
        rindow_matlib_d_notequal(n,x,incX,y,incY);
    }
    virtual void test_matlib_notequal(
        int32_t n,
        ...
        int32_t *y, int32_t incY)
    {
        ...
        rindow_matlib_i_notequal(dtype,n,x,incX,y,incY);
    }
    virtual void test_matlib_notequal(
        int32_t n,
        bool *x, int32_t incX,
...
TYPED_TEST_SUITE(NotEqualTest, TestTypes);

TYPED_TEST(NotEqualTest, normal) {
    const int32_t N = 3;
    ...
    this->test_matlib_notequal(N, X, incX, Y, incY);
    ...
    this->test_matlib_notequal(N, boolX, incX, boolY, incY);
